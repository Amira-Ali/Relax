...
public class recommendation_Sleeping extends AppCompatActivity {

    @RequiresApi(api = Build.VERSION_CODES.P)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.recommendation_sleeping);

        ActionBar actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle(R.string.SleepTitle);
        ...
        if (globalVariables.backURL != null && !globalVariables.backURL.equals("")) {
            ...
            if (globalVariables.backURL.equals("Home")) {
                ...
                globalVariables.backURL = "recommendation_Sleeping";
            }
