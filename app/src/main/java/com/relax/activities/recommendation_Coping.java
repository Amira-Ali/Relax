...
public class recommendation_Coping extends AppCompatActivity {

    @RequiresApi(api = Build.VERSION_CODES.P)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.recommendation_changes);

        ActionBar actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle(R.string.ChangeTitle);
        ...
        if (globalVariables.backURL != null && !globalVariables.backURL.equals("")) {
            ...
            if (globalVariables.backURL.equals("Home")) {
                ...
                globalVariables.backURL = "CopingWithChanges";
            }
